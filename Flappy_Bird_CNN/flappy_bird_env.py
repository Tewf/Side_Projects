...
def run_generator():
    ...
    # load images
    base = '~/Desktop/Flappy_Bird_CNN/images'
    game_images = {}
...
def Run():
    ...
    # File paths
    background_image   = '~/Desktop/Flappy_Bird_CNN/images/background.jpg'
    pipeimage          = '~/Desktop/Flappy_Bird_CNN/images/pipe.png'
    sealevel_image     = '~/Desktop/Flappy_Bird_CNN/images/base.jfif'
    birdplayer_image   = '~/Desktop/Flappy_Bird_CNN/images/bird.png'
    ...
    pygame.display.set_caption('Flappy Bird Game')      
        ...
        # Load all the images
    game_images['scoreimages'] = tuple(
            pygame.image.load(f'~/Desktop/Flappy_Bird_CNN/images/{i}.png').convert_alpha()
            for i in range(10)
        )
